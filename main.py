...
''')
    ...
    with st.container():
            st.write("---")
            st.markdown("<h3 style='text-align:center;'>Still doubt left ? 🤔 <br> Dont worry Dm me on Telegram 💡 </h5>",unsafe_allow_html=True)
            st.markdown("""
                <div style="display: flex; justify-content: center;">
                <div>
                    <a href='https://www.linkedin.com/in/dipanshu-garg24'><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-telegram" viewBox="0 0 16 16">
